...
class AddModalityScreen extends StatefulWidget {
  const AddModalityScreen({super.key});

  @override
  State<AddModalityScreen> createState() => _AddModalityScreenState();
}

class _AddModalityScreenState extends State<AddModalityScreen> {
                     ...
                     Padding(
                      ...
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: Theme.of(context).colorScheme.primary, width:3), //border of dropdown button
